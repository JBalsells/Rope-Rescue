...
ROPE_MBS_KN   = 30.0   # resistencia mínima de rotura cuerda estática (kN)
...
class FallSimulator:
    ...
    def draw(self):
        ...
        if not self.impact and self.climber_y_m < self.climber_end_m * 0.9:
            mid = (WALL_X + 25, int((anchor_px[1] + climber_px[1]) / 2 + 20))
            pygame.draw.lines(self.screen, rope_color, False, [anchor_px, mid, climber_px], 3)
        else:
            pygame.draw.line(self.screen, rope_color, anchor_px, climber_px, 3)
        ...
        pygame.draw.circle(self.screen, climber_color, (climber_px[0], head_y), 10)
        pygame.draw.line(self.screen, climber_color,
                         (climber_px[0], head_y + 10), (climber_px[0], climber_px[1] + 10), 3)
        pygame.draw.line(self.screen, climber_color,
